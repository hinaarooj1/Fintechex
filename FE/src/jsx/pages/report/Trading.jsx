        ...
        <>
            <div className="row">
                ...
                <div className="col-x-12">
                    <div className="card">
                        <Card.Header>
                            <Card.Title>{t("aiBot.stakingRewards")}</Card.Title>
                        </Card.Header>
                        <div className="card-body">
                            {isLoading ? (
                                <div className="text-center my-5">
                                    <Spinner animation="border" variant="primary" />
                                    <h4 className="mt-3">{t("aiBot.loading")}</h4>
                                </div>
                            ) : (
                                <>
                                                            ...
                                                            <Row className="align-items-center">
                                                                <Col>
                                                                    ...
                                                                    <Card.Text className="transaction-date d-md-none">
                                                                        {t("aiBot.transactionAt")}: {new Date(Transaction.createdAt).toLocaleString()}
                                                                    </Card.Text>
                                                                </Col>
